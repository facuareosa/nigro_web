  ...
  return (
    <section className='bg-custom-lightblue flex justify-center'>
        <div className='flex relative justify-center w-full max-w-7xl h-32 md:h-96 overflow-visible'>
            ...
            <img src={nigroLogo} alt="logo bodegón nigro" className={`absolute inset-1/2 transform -translate-x-1/2 -translate-y-[57%] h-24 md:h-80 transition-all duration-[2s] ${displayLogo ? 'opacity-100 scale-100' : 'opacity-0 scale-0'}`} />
        </div>
    </section>
  );
}
