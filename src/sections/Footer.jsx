        ...
        <div className='flex flex-col gap-8 px-4 w-full max-w-7xl my-8 mx-auto items-center'>
            <div className='grid grid-cols-2 md:grid-cols-3 w-full'>
                <div className='flex flex-col gap-4'>
                    <h3 className='uppercase w-fit border-y-2 border-solid border-custom-gray md:mx-0 text-white text-2xl font-bold'>contacto</h3>
                ...
                className="hidden md:block mx-8 md:mx-0 justify-self-center rounded-full md:w-28 h-20 md:h-28 shadow-custom border-solid border border-gray-400"
                />
                <div className='flex flex-col justify-self-end gap-4'>
                    <h3 className='uppercase w-fit border-y-2 border-solid border-custom-gray md:mx-0 text-white text-2xl font-bold'>horario</h3>
                    <div className='text-white md:text-xl'>
